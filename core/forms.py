...
class ExpensesForm(forms.Form):
    ...
    amount = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control mb-3', 'placeholder': 'Enter Amount'}))
...
class CustomerForm(forms.Form):
    customer_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control mb-3',
                                                                  'placeholder': "Customer's Name"}), max_length=100,
                                    required=True)
    customer_phone_number = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control mb-3',
        'placeholder': 'Phone Number'}), max_length=15, required=True)
